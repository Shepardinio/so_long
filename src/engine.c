...
/*   Updated: 2024/03/20 19:24:03 by mel-yand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_image(t_data *data)
{
	...
	if (!data->wall || !data->floor || !data->collect || !data->c_exit ||
		!data->o_exit || !data->player || !data->playerdoor || !data->f_faith)
...
void	render(t_data *data)
{
	...
	if (data->map[data->j][data->i] == 'P' && data->flg == 1)
		mlx_put_image_to_window(data->mlx, data->mlx_win, data->playerdoor, data->i * 64, data->j * 64);
